...
function MainMen() {
  return (
    <div className='relative flex flex-col items-center gap-[40px] bg-gray-i'>
      <div className='relative flex w-full items-center justify-between self-stretch bg-[#ffffff03] px-[20px] pb-[20px] pt-[30px] backdrop-blur-[30px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(30px)_brightness(100%)]'>
        <img
      ...
      <div className='relative flex w-full items-center gap-[10px] self-stretch px-[20px] py-0'>
        <InputComponent
          className='!my-[-1.00px] !ml-[-1.00px] !h-[50px] !w-[unset] !flex-1 !grow !border-2 !border-solid !border-gray-i !bg-white !shadow-shadow'
          eyeClassName='!mb-[-3.50px]'
          property1='search'
          property2='selected'
          vectorClassName='!mb-[-1.50px]'
        />
        <img className='relative h-[48px] w-[48px]' alt='Icon' src='https://c.animaapp.com/DB9yliXt/img/icon-10.png' />
      </div>
